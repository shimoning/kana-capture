...
export declare function setupObserver(input: HTMLInputElement | string, // TODO: support textarea (HTMLTextAreaElement)
outputs: OutputElement | OutputElement[], options?: Options): void;
